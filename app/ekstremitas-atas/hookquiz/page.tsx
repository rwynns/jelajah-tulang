        ...
        <div className="flex items-center justify-center">
          ...
          <div className="flex flex-col gap-8">
            <button onClick={() => playBoneSound("clavicula")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
              <Image src="/images/hookQuizImages/ekstremitas-atas/clavicula.png" alt="Clavicula" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
            </button>
            <button onClick={() => playBoneSound("wrist")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
              <Image src="/images/hookQuizImages/ekstremitas-atas/wrist.png" alt="Wrist" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
            </button>
          </div>
          ...
          <button onClick={() => playBoneSound("humerus")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-atas/humerus.png" alt="Humerus" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
          </button>
          ...
          <button onClick={() => playBoneSound("scapula")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-atas/scapula.png" alt="Scapula" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
          </button>
          ...
          <button onClick={() => playBoneSound("radius")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-atas/radius.png" alt="Radius" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
          </button>

          {/* Column 5: Ulna */}
          <button onClick={() => playBoneSound("ulna")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-atas/ulna.png" alt="Ulna" width={200} height={200} className="w-50 h-50 object-contain" placeholder="blur" blurDataURL={PURPLE_BLUR_DATA_URL} />
          </button>
        </div>
