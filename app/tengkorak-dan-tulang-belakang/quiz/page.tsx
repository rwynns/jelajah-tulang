...
const quizQuestions: Question[] = [
  {
    id: 1,
    question: "Manakah Yang Merupakan Fungsi Tengkorak?",
    type: "text",
    answers: [
      { id: "A", text: "A. Melindungi Otak Dari Benturan" },
      { id: "B", text: "B. Menopang Tubuh" },
      { id: "C", text: "C. Melindungi Sumsum Tulang Belakang" },
    ],
    correctAnswer: "A",
  },
  {
    ...
    image: "/images/quizImages/book1_question2.png",
    type: "image-question",
    answers: [
      { id: "A", text: "A. Sacrum" },
      { id: "B", text: "B. Cervikal" },
      { id: "C", text: "C. Lumbal" },
    ],
    correctAnswer: "A",
  },
  {
    id: 3,
    question: "Manakah Yang Merupakan Tulang Tengkorak?",
    type: "image-answer",
    answers: [
      { id: "A", image: "/images/quizImages/book1_answer1.png" },
      { id: "B", image: "/images/quizImages/book1_answer2.png" },
      { id: "C", image: "/images/quizImages/book1_answer3.png" },
    ],
    correctAnswer: "A",
  },
  {
    id: 4,
    question: "Dibagi menjadi berapakah tulang vertebra?",
    type: "text",
    answers: [
      { id: "A", text: "A. 12" },
      { id: "B", text: "B. 7" },
  ...
  {
    id: 5,
    question: "Tulang yang berfungsi untuk menyeimbangkan posisi ketika duduk?",
    type: "text",
    answers: [
      { id: "A", text: "A. Cervical" },
      { id: "B", text: "B. Coccxye" },
      { id: "C", text: "C. Thorakal" },
    ],
    correctAnswer: "B",
  },
];
