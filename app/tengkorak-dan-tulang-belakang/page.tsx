...
export default function TengkorakDanTulangBelakang() {
  return (
    <div className="relative flex items-center justify-center w-full h-screen">
      ...
      <div className="relative z-10 w-full max-w-5xl px-8">
        <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
          <iframe
            ...
            src="https://www.youtube.com/embed/FA4EvjKkuxg"
            title="Video Pembelajaran Tengkorak dan Tulang Belakang"
      ...
      {/* Next Button */}
      <Link href="/tengkorak-dan-tulang-belakang/hookquiz" className="absolute bottom-20 right-10 z-10 w-auto hover:opacity-70 transition-opacity">
        <div className="flex flex-col items-center">
