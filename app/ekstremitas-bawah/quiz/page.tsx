...
const quizQuestions: Question[] = [
  {
    id: 1,
    question: "Tulang Yang Manakah Memiliki Fungsi Melindungi dan Membungkus Sendi Lutut?",
    type: "text",
    answers: [
      { id: "A", text: "A. Pelvis" },
      { id: "B", text: "B. Patella" },
  ...
  {
    id: 2,
    question: "Apa Nama Tulang Ini?",
    image: "/images/quizImages/book3_question1.png",
    type: "image-question",
    answers: [
      { id: "A", text: "A. Tibia" },
      { id: "B", text: "B. Fibula" },
  ...
  {
    id: 3,
    question: "Apakah Fungsi Dari Pelvis?",
    type: "text",
    answers: [
      { id: "A", text: "A. Penyambung Antara Ekstremitas Atas dan Ekstremitas Bawah" },
      { id: "B", text: "B. Membungkus dan Melindungi Sendi Lutut" },
      { id: "C", text: "C. Menghubungkan Patella Dengan Kaki" },
    ],
    correctAnswer: "A",
  },
  {
    id: 4,
    question: "Manakah yang Merupakan Gambar Tulang Femur?",
    type: "image-answer",
    answers: [
      { id: "A", image: "/images/quizImages/book3_answer1.png" },
      { id: "B", image: "/images/quizImages/book3_answer2.png" },
      { id: "C", image: "/images/quizImages/book3_answer3.png" },
    ],
    correctAnswer: "C",
  },
  {
    id: 5,
    question: "Menendang Bola, Berlari, dan Berjalan Merupakan Fungsi Dari Tulang Bagian?",
    type: "text",
    answers: [
      { id: "A", text: "A. Cervical" },
      { id: "B", text: "B. Ekstremitas Bawah" },
      { id: "C", text: "C. Ekstremitas Atas" },
    ],
    correctAnswer: "B",
  },
];
