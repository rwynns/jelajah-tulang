      ...
      <div className="relative z-10 w-full max-w-7xl px-8">
        ...
        <div className="flex items-center justify-center gap-8">
          ...
          <button onClick={() => playBoneSound("phalang")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-bawah/phalang.png" alt="Phalang" width={200} height={200} className="w-50 h-50 object-contain" priority />
          </button>
          ...
          <button onClick={() => playBoneSound("fibula")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-bawah/fibula.png" alt="Fibula" width={200} height={200} className="w-50 h-50 object-contain" priority />
          </button>

          {/* Tibia */}
          <button onClick={() => playBoneSound("tibia")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-bawah/tibia.png" alt="Tibia" width={200} height={200} className="w-50 h-50 object-contain" priority />
          </button>

          {/* Femur */}
          <button onClick={() => playBoneSound("femur")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-bawah/femur.png" alt="Femur" width={200} height={200} className="w-50 h-50 object-contain" priority />
          </button>
          ...
          <button onClick={() => playBoneSound("pelvis")} className="hover:scale-110 hover:opacity-70 transition-all duration-300 cursor-pointer">
            <Image src="/images/hookQuizImages/ekstremitas-bawah/pelvis.png" alt="Pelvis" width={200} height={200} className="w-50 h-50 object-contain" priority />
          </button>
        </div>
